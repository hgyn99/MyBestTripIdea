  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"></path>
    ...
    {isModalOpen &&  (
        <>
            ...
            <ImagePreviewModal>
            {preview ? <img src={preview} alt="Preview" style={{maxWidth: '100%', maxHeight: '300px', marginBottom: '10px'}} /> : null}
            <ButtonContainer>
    <PreviewButton onClick={onModalSubmit}>전송</PreviewButton>
    <PreviewButton onClick={onModalCancel} style={{ backgroundColor: '#DC3545', borderColor: '#C82333' }}>취소</PreviewButton>
        </ButtonContainer>
            </ImagePreviewModal>
        </>
    )}
